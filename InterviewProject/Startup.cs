...
namespace InterviewProject
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<DatabaseContext>(option=> option.UseSqlServer(Configuration.GetConnectionString("LocalConnection")));
            services.AddDbContext<ApplicationDatabaseContext>(option => option.UseSqlServer(Configuration.GetConnectionString("LocalConnection")));
